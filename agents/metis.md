...
Use `explore` and `librarian` capabilities (via your own tools) to gather context.
...
2. Use tools to gather context as user provides direction
...
- **`read`/`grep`/`glob`**: Codebase pattern discovery — Build, Research
